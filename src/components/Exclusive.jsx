...
const Exclusive = () => {
    return (
        <div className='bg-pink-200 mt-10 flex items-center justify-center h-64 w-[90%] sm:w-[80%] m-auto'>
            <div className='ml-5 w-[100%]'>
                ...
                <button className='rounded-3xl border w-20 p-1 text-xs bg-red-500 mt-2 text-white'>Check now</button>
            </div>
            <div >
