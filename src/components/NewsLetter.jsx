...
const NewsLetter = () => {
    return (
        <div className='bg-gradient-to-b from-pink-200 to-white h-72 mt-4 w-[90%] m-auto font-[Roboto]'>
            ...
            <div className='mt-2 text-center'>
                <input type="email" placeholder='Your Email id' className='border-r-0 p-2 rounded-3xl rounded-r-none text-sm sm:w-64' />
